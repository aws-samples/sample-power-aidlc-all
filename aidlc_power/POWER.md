...
5. Activate the AI-DLC workflow from the selected phase.
6. If the user selects "No thanks" → proceed normally without AI-DLC.
7. Once answered, the agent remembers the choice for the rest of the conversation and does not ask again.
